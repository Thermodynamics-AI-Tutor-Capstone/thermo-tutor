...
12. ⭐⭐ **Students don't want hints and don't want to chat — they want their own work checked.**
    ...
    directive "Next Step" was used by **9**, and **"AI Tutor Chat" and "Hint" were *rarely used*.**
    That sits beside [PeteChat's 0.0% hint utilisation](systems/petechat-purdue.md),
    [CycleTalk's 14% help-request rate](systems/cyclepad-cycletalk.md), and
    [the RAG+SRL tutor where "guided support" attached to a specific problem was the *most*-used
    mode](systems/rag-tutor-southeast.md).

    **They agree once you stop treating "help" as one thing.** Students reliably decline to be
    *told* and reliably accept having **what they already produced evaluated**. A UIC student
    described the same workflow unprompted: *"I always ask for answers to questions after solving
    it by myself first."*

    > **The unit students want is not a hint. It is a verdict on work they have already done.**

    **"Evaluate my work" should be the front door of our tutor, not a feature behind a hint menu**
