...
|---|---|---|---|
| [CS50 Duck](cs50-duck.md) | Harvard | CS | Largest course-embedded deployment. 9.4M prompts |
| [Jill Watson](jill-watson.md) | Georgia Tech | CS (KBAI) | First AI TA; grounding+verification beats raw model 2.5× |
| [Stan](stan-udel.md) | U. Delaware | **Thermodynamics** | **Our closest competitor** |
| [PeteChat](petechat-purdue.md) | Purdue | Python (ECE 20875) | Closest methodological sibling; "Tutor, Not Solver" |
...
| System | Institution | Domain | Why it matters |
|---|---|---|---|
| [Andes](andes.md) | Pitt + US Naval Academy | **Physics** | Step-based; closest historical analogue to us |
...
2. [Stan](stan-udel.md) — our competitor
3. [Khanmigo](khanmigo.md) — the engagement lesson
4. [Andes](andes.md) — what "good" looked like before LLMs
5. [Tutor CoPilot](tutor-copilot.md) — the alternative project shape
